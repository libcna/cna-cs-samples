...
Observed symptom: **exit 134 (SIGABRT) at shutdown, from a captured component-callback failure rethrown by Dispose**.
...
`/rv/tmp/cs-samples/WaypointSample/evidence/release/run.log`
